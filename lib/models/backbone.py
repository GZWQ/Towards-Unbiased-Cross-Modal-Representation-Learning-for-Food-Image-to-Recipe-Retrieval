...
def get_model_path(modelname):
    ...
    pretrained_dir = '/common/home/users/q/qingwang.2020/codes/query2labels/pretrained_models'
    PTDICT = {
        'CvT_w24': 'CvT-w24-384x384-IN-22k.pth',
        'swin_B_224_22k': 'swin_base_patch4_window7_224_22k.pth',
        'swin_L_224_22k': 'swin_large_patch4_window7_224_22k.pth',
...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        if name in ['resnet18', 'resnet50', 'resnet34', 'resnet101']:
            ...
            # self.in_feats = backbone.fc.in_features
            if return_interm_layers:
                return_layers = {"layer1": "0", "layer2": "1", "layer3": "2", "layer4": "3"}
            else:
                return_layers = {'layer4': "0"}
...
class Joiner(nn.Sequential):
    def __init__(self, backbone, position_embedding, args=None):
        ...
        # self.in_feats = backbone.in_feats
