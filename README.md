...
Here we use the recipe1M dataset for training and evaluation. You can download the data files from [Google](https://drive.google.com/drive/folders/1lHvTJMsPISkPEFlZIi8p0CcgKqggF5Fp?usp=drive_link) or [Baidu](https://pan.baidu.com/s/1D-Ke1yjcVYKF0W2OLlxoLw?pwd=23ux). 
...
You can also download the dictionry from [Google](https://drive.google.com/drive/folders/1AvlBZ8ibncF1BBCmSXezKV73Cvczi_7m?usp=drive_link) or [Baidu](https://pan.baidu.com/s/10qLQ3vqBx2egbRedtlLBrw?pwd=ac53).
...
The training log is in **"./logs/s2_debiasing.out"**  and the checkpoint can be also downloaded from [Google](https://drive.google.com/drive/folders/1PzLIcNR8hgcaY6vR83lF7F7r2UPIWC2-?usp=drive_link) or [Baidu](https://pan.baidu.com/s/19EEg1ayFKCxc3N00ikJZTQ?pwd=ethm).
