...
Here we use the recipe1M dataset for training and evaluation. You can download the data files from [Google](https://drive.google.com/drive/folders/1lHvTJMsPISkPEFlZIi8p0CcgKqggF5Fp?usp=drive_link) or [Baidu](通过网盘分享的文件：data
链接: https://pan.baidu.com/s/1D-Ke1yjcVYKF0W2OLlxoLw?pwd=23ux 提取码: 23ux). 
...
You can also download the dictionry from [Google](https://drive.google.com/drive/folders/1AvlBZ8ibncF1BBCmSXezKV73Cvczi_7m?usp=drive_link) or [Baidu](通过网盘分享的文件：ingredient_dict_textual.pkl
链接: https://pan.baidu.com/s/10qLQ3vqBx2egbRedtlLBrw?pwd=ac53 提取码: ac53 
--来自百度网盘超级会员v1的分享).
...
The training log is in **"./logs/s2_debiasing.out"**  and the checkpoint can be also downloaded from [Google](https://drive.google.com/drive/folders/1PzLIcNR8hgcaY6vR83lF7F7r2UPIWC2-?usp=drive_link) or [Baidu](通过网盘分享的文件：model_best.pth.tar
链接: https://pan.baidu.com/s/19EEg1ayFKCxc3N00ikJZTQ?pwd=ethm 提取码: ethm 
--来自百度网盘超级会员v1的分享).
